...
class WmidealodeSpider(scrapy.Spider):
    ...
    def parse_product(self,response):
        ...
        rpm = response.css("#datasheet > div.datasheet-wrapper > table > tbody:contains('max. Schleuderdrehzahl') > tr:contains('U/Min') > td.datasheet-listItemValue.small-6.larger-8.columns::text").get().split()[0].replace(".","")
