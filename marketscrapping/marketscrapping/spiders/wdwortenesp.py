...
class WdwortenespSpider(scrapy.Spider):
    name = "wdwortenesp"
    start_urls = ["file:///C:/Users/gorkemk/PycharmProjects/Market-Search/marketscrapping/HTML%20Files/wdwortensesp/page1.html"]
    product_counter = 0
    page_counter = 1
    def parse(self, response):
        ...
        for i in range(2, 2*len(product_urls)+1,2):
            try:
                ...
                capacity_both = label.split("(")[1].split("-")[0].replace("kg","").replace(" ","")
                capacity = capacity_both.split("/")[-1]
                capacity_dry = capacity_both.split("/")[0]
                ...
                print(e)
        self.page_counter += 1
        next_url = fr"file:///C:/Users/gorkemk/PycharmProjects/Market-Search/marketscrapping/HTML%20Files/wdwortensesp/page{self.page_counter}.html"
