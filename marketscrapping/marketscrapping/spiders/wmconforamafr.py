        ...
        for i in range(len(product_urls)):
            try:
                if response.css(f"#contentSegment > div.c-r_descent-container > div > article:nth-child({i}) div.awk-desc-product.product-pointfort li:nth-child(1) span::text").get() == None:
                    ...
                    capacity = response.css(f"#contentSegment > div.c-r_descent-container > div > article:nth-child({i}) div.awk-desc-product.product-pointfort li:nth-child(1) span::text").get()
                    capacity = self.parse_product_info(capacity)[0]
                ...
                database_adress = r'French Market\washingmachines_fr.db'
